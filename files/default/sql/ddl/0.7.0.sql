...
CREATE TABLE IF NOT EXISTS `feature_group` (
  ...
  `feature_corr_matrix_img` MEDIUMTEXT          DEFAULT NULL,
  `features_histogram_img`  LONGTEXT            DEFAULT NULL,
  `descriptive_stats`       MEDIUMTEXT          DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `training_dataset` (
  ...
  `input_dataset`           VARCHAR(10000)        DEFAULT NULL,
  `version`                 INT(11)      NOT NULL,
  `dataset_schema`          MEDIUMTEXT            DEFAULT NULL,
  `descriptive_stats`       MEDIUMTEXT            DEFAULT NULL,
